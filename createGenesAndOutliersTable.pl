...
open(BINOM, "< /groups/umcg-bios/tmp03/projects/outlierGeneASE/logFoldChangeTables/genotypes_BIOS_LLDeep_Diagnostics_merged_phasing_noRnaEditing.logFoldChange.depthFiltere.BINOM.txt") || die "Can't open input BINOM file!\n";
my @BINOMfile = <BINOM>;
close(BINOM);
